...
10. As far as I understand the classical inheritance gives all the children the same properties but also a chance to change or delete those properties, in prototype inheritance it is impossible to delete a prototype defined property.
